    ...
    protected void configure(HttpSecurity http) throws Exception {
     /*   response.sendRedirect("/load-yard-manager-own");
        ...
        http.authorizeRequests()
                .antMatchers("/loadPage", "/login", "/logout", "/loadFormRegister", "/login","/showDetail").permitAll()
                ...
                .antMatchers("/booking","/loadMatching"/*,"/loadPage"*/).hasAuthority("USER")
                // Trang chỉ dành cho ADMIN
                .antMatchers("/admin", "/loadPitchNotAllow","/frofileAdmin").hasAuthority("ADMIN")
                ...
                .failureHandler(getAuthenticationFailureHandler())//trang 404
                .permitAll()
